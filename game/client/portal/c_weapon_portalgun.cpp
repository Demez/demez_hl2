...
PRECACHE_MATERIAL( PORTALGUN_BEAM_SPRITE )
PRECACHE_MATERIAL( PORTALGUN_BEAM_SPRITE_NOZ )
PRECACHE_MATERIAL( PORTALGUN_GLOW_SPRITE )
PRECACHE_MATERIAL( PORTALGUN_ENDCAP_SPRITE )
PRECACHE_MATERIAL( PORTALGUN_GRAV_ACTIVE_GLOW )
PRECACHE_MATERIAL( PORTALGUN_PORTAL1_FIRED_LAST_GLOW )
PRECACHE_MATERIAL( PORTALGUN_PORTAL2_FIRED_LAST_GLOW )
PRECACHE_MATERIAL( PORTALGUN_PORTAL_MUZZLE_GLOW_SPRITE )
PRECACHE_MATERIAL( PORTALGUN_PORTAL_TUBE_BEAM_SPRITE )
...
//-----------------------------------------------------------------------------
int C_WeaponPortalgun::DrawModel( int flags RENDER_INSTANCE_INPUT )
{
	...
	int iRetValue = BaseClass::DrawModel( flags RENDER_INSTANCE );
