...
PRECACHE_MATERIAL( "models/portals/portal_1_dynamicmesh" )
PRECACHE_MATERIAL( "models/portals/portal_2_dynamicmesh" )
PRECACHE_MATERIAL( "models/portals/portal_1_renderfix_dynamicmesh" )
PRECACHE_MATERIAL( "models/portals/portal_2_renderfix_dynamicmesh" )
#endif
PRECACHE_MATERIAL( "models/portals/portal_depthdoubler" )
PRECACHE_MATERIAL( "models/portals/portalstaticoverlay_1" )
PRECACHE_MATERIAL( "models/portals/portalstaticoverlay_2" )
PRECACHE_MATERIAL( "models/portals/portal_stencil_hole" )
PRECACHE_MATERIAL( "models/portals/portal_refract_1" )
PRECACHE_MATERIAL( "models/portals/portal_refract_2" )
//PRECACHE_MATERIAL( "effects/flashlight001" ) //light transfers disabled indefinitely
