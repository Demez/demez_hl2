...
static ConVar r_flashlightoffsetx( "r_flashlightoffsetright", "10.0", FCVAR_CHEAT );
...
static ConVar r_flashlightoffsetz( "r_flashlightoffsetforward", "24.0", FCVAR_CHEAT );
