...
public:
...
#if ENGINE_CSGO
	virtual void SetMDL( MDLHandle_t handle, CCustomMaterialOwner* pCustomMaterialOwner, void *pProxyData );
	virtual void SetMDL( const char *pMDLName, CCustomMaterialOwner* pCustomMaterialOwner, void *pProxyData );
#else
	...
	void SetModelAnim( int iAnim, bool bUseSequencePlaybackFPS = true );
	void SetModelAnim( const char *pszName, bool bUseSequencePlaybackFPS = true );
