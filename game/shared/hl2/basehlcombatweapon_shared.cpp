...
LINK_ENTITY_TO_CLASS_DUMB( basehlcombatweapon, CBaseHLCombatWeapon );
...
// #if defined( CLIENT_DLL ) // && ( !defined( HL2MP ) && !defined( PORTAL_DLL ) )
#if defined( CLIENT_DLL ) && !defined( PORTAL_DLL )
